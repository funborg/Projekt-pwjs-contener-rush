...
export default class creditsButton extends Phaser.GameObjects.Text {
    constructor(scene, x, y) {

        //setting position and text of start button
        super(scene, x, y, 'CREDITS', { fontFamily: 'Stencil', fontSize: 64, color: '#085b80' });
        this.setOrigin(0.5);
        ...
        this.on('pointerdown', () => {
            ...
            scene.scene.switch('CreditsScene');
        });
